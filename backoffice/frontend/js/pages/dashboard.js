...
<div class="two-col">
 ...
 <div class="bar-col">
 <div class="bar-val">${frS(c.revenue || 0).replace('Rp ', '')}</div>
 <div class="bar" style="height:${Math.max(10, Math.round((c.revenue || 0) / 2000000 * 100))}px" title="${frS(c.revenue || 0)}"></div>
