...
async function run() {
  ...
  const resF1Get = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/settings/demo-outlet?tenantId=demo-tenant');
  ...
  const resF1Put = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/settings/demo-outlet', {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(putBodyF1)
  });
  
  const resF1Get2 = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/settings/demo-outlet?tenantId=demo-tenant');
  ...
  const resF2Put = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/settings/demo-outlet', {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(putBodyF2)
  });
  
  const resF2Get = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/settings/demo-outlet?tenantId=demo-tenant');
  ...
  const resM1Get = await fetch('https://nashty-backoffice-backend-production.up.railway.app/api/auth/me', {
