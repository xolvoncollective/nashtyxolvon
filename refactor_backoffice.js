...
const srcFile = path.join(__dirname, 'NASHTY_Backoffice_Mockup_8.html');
const destDir = path.join(__dirname, 'frontend', 'backoffice');
...
console.log('Backoffice refactoring complete!');
