...
- [ ] 1.1 Set up test infrastructure for FinancialCalculationService
...
- [~] 1.2 Write exploratory test for gross sales formula bug
...
- [~] 1.3 Write exploratory test for net sales formula bug
...
- [~] 1.4 Write exploratory test for precision loss bug
...
- [~] 1.5 Write exploratory test for missing COGS bug
...
- [~] 1.6 Run exploratory tests and document counterexamples
...
- [~] 2.1 Fix net sales formula in FinancialCalculationService.getShiftSummary()
