...
-- SIMPLIFIED - Based on Actual Database Schema with UUIDs
-- ═══════════════════════════════════════════════════════════════════
...
VALUES ('00000000-0000-0000-0000-000000000001'::uuid, 'Nashty Hot Chicken', 'nashty', 'pro', 'active')
...
VALUES (
  ...
  'Galaxy Mall', 
  'galaxy-mall', 
  'Jl. Galaxy Raya No.1, Lt. 3, Surabaya', 
  '031-8123456', 
  'active'
)
ON CONFLICT (id) DO NOTHING;
